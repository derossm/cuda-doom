...
// interaction info
	...
	fixed_t floorz;
	fixed_t ceilingz;					// closest together of contacted secs
	fixed_t radius;
	...
	// [AM] Previous position of mobj before think. Used to interpolate between positions.
	fixed_t oldx;
	fixed_t oldy;
	fixed_t oldz;
	angle_t oldangle;
...
#define MF2_PASSMOBJ		0x00001000	// Enable z block checking. If on, this flag will allow the mobj to pass over/under other mobjs.
...
struct player_t
{
	...
	int armorpoints;						// armor type is 0-2
	int armortype;
	...
	// [AM] Previous position of viewz before think. Used to interpolate between camera positions.
	angle_t oldviewz;
};
