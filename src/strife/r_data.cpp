...
void R_InitTextures()
{
	...
	names = W_CacheLumpName(DEH_String("PNAMES"), pu_tags_t::PU_STATIC);
	...
	maptex = maptex1 = W_CacheLumpName(DEH_String("TEXTURE1"), pu_tags_t::PU_STATIC);
	...
	{
		maptex2 = W_CacheLumpName(DEH_String("TEXTURE2"), pu_tags_t::PU_STATIC);
