...
constexpr size_t NUM_VIRTUAL_BUTTONS{11};
...
constexpr size_t BUTTON_AXIS{0x10000};
...
constexpr size_t HAT_AXIS{0x20000};
...
constexpr size_t HAT_AXIS_HORIZONTAL{1};
constexpr size_t HAT_AXIS_VERTICAL{2};
