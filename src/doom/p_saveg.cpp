...
char* P_SaveGameFile(int slot)
{
	...
	if (filename == NULL)
	{
		...
		filename = static_cast<decltype(filename)>(malloc(filename_size));
	}
...
#define saveg_read_enum class saveg_read32
#define saveg_write_enum class saveg_write32
