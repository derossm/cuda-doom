...
void NET_AddModule(net_context* context, net_module_t* mod); // TODO URGENT REFACTOR NAME
...
bool NET_RecvPacket(net_context* context, net_addr_t** addr, net_packet_t** packet);
