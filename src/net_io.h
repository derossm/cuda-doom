...
void NET_AddModule(net_context_t* context, net_module_t* module); // TODO URGENT REFACTOR NAME
...
bool NET_RecvPacket(net_context_t* context, net_addr_t** addr, net_packet_t** packet);
