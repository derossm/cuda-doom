...
{
	// if we make a short sequence on a cheat with parameters, this will not work in vanilla doom. behave the same.
	...
	{
		// still reading characters from the cheat code and verifying. reset back to the beginning if a key is wrong
	...
	{
		// we have passed the end of the cheat sequence and are entering parameters now
