...
// This is an internal data structure. Good programmers will not use it except as an argument to one of the functions below.
...
struct DIR
{
	...
	// dirent struct to return from dir (NOTE: this makes this thread safe as long as only one thread uses a particular DIR struct at a time)
	dirent dd_dir;
